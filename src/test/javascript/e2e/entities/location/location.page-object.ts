...
export class LocationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('companyApp.location.delete.question'));
...
export default class LocationComponentsPage {
  ...
  async deleteLocation() {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/companyApp.location.delete.question/);
