...
export class DepartmentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('companyApp.department.delete.question'));
...
export default class DepartmentComponentsPage {
  ...
  async deleteDepartment() {
    ...
    expect(await departmentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/companyApp.department.delete.question/);
