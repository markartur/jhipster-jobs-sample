  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="companyApp.employee.home.createOrEditLabel">
            <Translate contentKey="companyApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : employeeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="salaryLabel" for="employee-salary">
                  <Translate contentKey="companyApp.employee.salary">Salary</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="commissionPctLabel" for="employee-commissionPct">
                  <Translate contentKey="companyApp.employee.commissionPct">Commission Pct</Translate>
                </Label>
                <AvField id="employee-commissionPct" type="string" className="form-control" name="commissionPct" />
              </AvGroup>
              <AvGroup>
                <Label for="employee-manager">
                  <Translate contentKey="companyApp.employee.manager">Manager</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="employee-department">
                  <Translate contentKey="companyApp.employee.department">Department</Translate>
                </Label>
