  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="companyApp.department.home.createOrEditLabel">
            <Translate contentKey="companyApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
