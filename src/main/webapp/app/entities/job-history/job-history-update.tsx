  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="companyApp.jobHistory.home.createOrEditLabel">
            <Translate contentKey="companyApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="startDateLabel" for="job-history-startDate">
                  <Translate contentKey="companyApp.jobHistory.startDate">Start Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="endDateLabel" for="job-history-endDate">
                  <Translate contentKey="companyApp.jobHistory.endDate">End Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="languageLabel" for="job-history-language">
                  <Translate contentKey="companyApp.jobHistory.language">Language</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="FRENCH">{translate('companyApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('companyApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('companyApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="job-history-job">
                  <Translate contentKey="companyApp.jobHistory.job">Job</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="job-history-department">
                  <Translate contentKey="companyApp.jobHistory.department">Department</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="job-history-employee">
                  <Translate contentKey="companyApp.jobHistory.employee">Employee</Translate>
                </Label>
